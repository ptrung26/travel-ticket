...
import { SysUserDto, TaiKhoanBaseCustomServiceProxy } from '@app/shared/service-proxies/tai-khoan-service-proxies';
...
export class ChangePwdComponent {
  ...
  forms: OrdFormItem[] = [
    ...
    },
    {
      ...
      type: 'form-builder',
      option: {
        formBuilderType: 'nhan-luc-select'
      },
      width: 24,
      disabled: true
    },
