...
import { OrdOverlayContentComponent } from '@app/shared/customize-comp/ord-overlay-tringer/ord-overlay-content/ord-menu.component';
...
export class OrdOverlayTringgerDirective implements OnInit, OnDestroy, AfterViewInit {
  ...
  private get positons(): ConnectionPositionPair[] {
    return [POSITION_MAP[this.menupositons], POSITION_MAP.top, POSITION_MAP.rightTop, POSITION_MAP.bottomLeft, POSITION_MAP.rightBottom];
  }
