...
const VALUE_ACCESSOR: Provider = {
  ...
  useExisting: forwardRef(() => OrdDatePickerMonthComponent),
  multi: true,
};

@Component({
  selector: 'ord-date-picker-month',
  template: `
...
export class OrdDatePickerMonthComponent implements OnInit, ControlValueAccessor, AfterViewInit, OnDestroy {
  ...
  mouseEnterMain() {
    setTimeout(() => {
      this.isShowIconCalendar = AppUtilityService.isNullOrEmpty(this.inputValue.value);
    });
  }
