<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="box">
      ...
      <p>Chúng tôi đã nhận được yêu cầu khôi phục tài khoản! Vui lòng nhấp vào liên kết sau để đặt lại mật khẩu của bạn.</p>
      <a class="link" href="{{model.url}}">Đặt lại mật khẩu</a>
    </div>
  </body>
</html>
