<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="box">
      ...
      <p>
        Tên tài khoản: <span style="color: #15c; font-weight: bold"> {{model.tendangnhap}}</span>
      </p>
      <p>Mật khẩu: <b>{{model.matkhau}}</b></p>
      <p>
        Để đăng nhập vào tài khoản, xin vui lòng click vào liên kết dưới đây
      </p>
      <a class="link" href="{{model.urllogin}}"> Đăng nhập vào tài khoản của bạn </a>
    </div>
  </body>
</html>
