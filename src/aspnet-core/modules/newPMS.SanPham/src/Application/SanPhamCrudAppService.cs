...
{
    //[Authorize]
    public class SanPhamCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput> : CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput>
   ...
   where TGetListInput : IPagedResultRequest
    {
        ...
        public SanPhamCrudAppService(IOrdAppFactory appFactory) : base(appFactory.Repository<TEntity, TKey>())
        {
