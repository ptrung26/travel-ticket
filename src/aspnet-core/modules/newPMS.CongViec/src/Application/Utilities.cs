...
namespace newPMS.CongViec
{
    public static class Utilities
    {
        private static string[] VietnameseSigns = new string[]
       {
        ...
        public const string ApiUrlBase = "api/cong-viec/[controller]/";
        public const string ApiUrlActionBase = "api/cong-viec/[controller]/[action]";
        public const string ApiBaseUrl = "api/cong-viec";
