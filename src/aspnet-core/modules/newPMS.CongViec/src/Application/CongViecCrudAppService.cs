...
{
    //[Authorize]
    public class CongViecCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput> : CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput>
   ...
   where TGetListInput : IPagedResultRequest
    {
        ...
        public CongViecCrudAppService(IOrdAppFactory appFactory) : base(appFactory.Repository<TEntity, TKey>())
        {
