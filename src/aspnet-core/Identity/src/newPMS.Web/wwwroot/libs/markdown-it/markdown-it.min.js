  ...
  })(
    {
      ...
      16: [
        function (e, r, t) {
          ...
          (i.code_inline = function (e, r, t, n, s) {
            var i = e[r];
            return (
              "<code" + s.renderAttrs(i) + ">" + o(e[r].content) + "</code>"
            );
          }),
            ...
            return (
              ...
              (s ||
                ...
                ((c = e.push("heading_open", "h" + String(i), 1)).markup =
                  "########".slice(0, i)),
                (c.map = [r, e.line]),
                ((c = e.push("inline", "", 0)).content = e.src
                  .slice(l, u)
                  .trim()),
                (c.map = [r, e.line]),
                (c.children = []),
          ...
          r.exports = function (e, r, t, n) {
            ...
            for (
              ...
              for (
                E = q,
                  b = e.eMarks[v],
                  p = C = e.sCount[v] + q - (e.bMarks[r] + e.tShift[r]);
                E < b;
      ...
      27: [
        function (e, r, t) {
          ...
          r.exports = function (e, r, t, o) {
            ...
            for (
              A = (k = e.getLines(r, w, e.blkIndent, !1).trim()).length, x = 1;
              x < A;
              x++
            ) {
              ...
              (10 === i || (92 === i && ++x < A && 10 === k.charCodeAt(x))) &&
                y++;
            }
            ...
            if (((u = e.md.normalizeLink(_.str)), !e.md.validateLink(u)))
              return !1;
            for (a = x = _.pos, c = y += _.lines, g = x; x < A; x++)
              if (10 === (i = k.charCodeAt(x))) y++;
              else if (!s(i)) break;
            for (
              _ = e.md.helpers.parseLinkTitle(k, x, A),
                x < A && g !== x && _.ok
                  ? ((C = _.str), (x = _.pos), (y += _.lines))
                  : ((C = ""), (x = a), (y = c));
            ...
            return (
              ...
              (o ||
                ...
                void 0 === e.env.references[f] &&
                  (e.env.references[f] = { title: C, href: u }),
                (e.parentType = m),
                (e.line = r + y + 1)),
              !0)
            );
          ...
          r.exports = function (e, r, t, i) {
            ...
            for (
              ...
              for (
                ...
                ((d = e.push("td_open", "td", 1)).map = [p, p + 1]),
                  m[u] && (d.attrs = [["style", "text-align:" + m[u]]]),
                  ((d = e.push("inline", "", 0)).map = [p, p + 1]),
          ...
          r.exports = function (e) {
            ...
            if (e.md.options.linkify)
              for (t = 0, o = C.length; t < o; t++)
                if (
                  "inline" === C[t].type &&
                  e.md.linkify.pretest(C[t].content)
                )
                    ...
                    if ("link_close" !== (c = i[r]).type) {
                      if (
                        ...
                        f < p.length &&
                          ...
                          (a.level = d),
                          l.push(a)),
                          (C[t].children = i = n(i, r, l));
                      }
                    } else
                      for (
                        r--;
                        i[r].level !== c.level && "link_open" !== i[r].type;
      ...
      35: [
        function (e, r, t) {
          ...
          function l(e, r) {
            var t, i, l, u, p, h, f, d, m, _, g, k, b, v, C, y, x, A, w, D, E;
            for (w = [], t = 0; t < e.length; t++) {
              for (
                i = e[t], f = e[t].level, x = w.length - 1;
                x >= 0 && !(w[x].level <= f);
                x--
              );
            ...
            return (
              ...
              (t = (function (e) {
                ...
                for (s = n[e] = [], r = 0; r < 128; r++)
                  (t = String.fromCharCode(r)), s.push(t);
        ...
        function (e, r, t) {
          ...
          (n.prototype.parse = function (e, r) {
            ...
            if (
              ...
              for (
                -1 !==
                  (b = -1 === v ? m.lastIndexOf("@") : m.lastIndexOf("@", v)) &&
            ...
            !(function (n) {
              ...
              function A(e) {
                var r,
                  ...
                  x = [];
                for (
                  f = (e = b(e)).length, r = 128, t = 0, o = 72, i = 0;
                  i < f;
                  ++i
                )
                    ...
                    if (((h = e[i]) < r && ++t > l && _("overflow"), h == r)) {
                      for (
                        ...
                        (v = c - p),
                          ...
                          x.push(m(C(p + (v % k), 0))),
                          (c = d(v / k));
                      x.push(m(C(c, 0))), (o = y(t, g, n == s)), (t = 0), ++n;
                    }
                  ++t, ++r;
                }
                return x.join("");
