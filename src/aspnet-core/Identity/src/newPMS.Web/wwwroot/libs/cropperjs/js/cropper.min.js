...
!(function (t, e) {
  ...
  function gt(t, e) {
    return _(t[e])
      ...
      : t.dataset
      ? t.dataset[e]
      : t.getAttribute("data-".concat(ut(e)));
  }
  function ft(t, e, i) {
    _(i)
      ? (t[e] = i)
      : t.dataset
      ? (t.dataset[e] = i)
      : t.setAttribute("data-".concat(ut(e)), i);
  }
  var vt,
    wt,
    bt,
  ...
  function Ht(t) {
    ...
    return (
      null !== e &&
      (e[1] !== Et.protocol || e[2] !== Et.hostname || e[3] !== Et.port)
    );
  }
  function Nt(t) {
  ...
  var At = {
      ...
      initContainer: function () {
        ...
        ct(a, { width: (this.containerData = r).width, height: r.height }),
          dt(t, A),
          lt(a, A);
      },
      initCanvas: function () {
        ...
        e &&
          ...
          ct(
            ...
            rt(
              ...
              Lt({ translateX: h.left, translateY: h.top })
            )
          ),
          this.renderImage(t),
      ...
      limitCropBox: function (t, e) {
        ...
        t &&
          ...
          (i = d
            ? Math.min(h.width, s.width, s.width + s.left, h.width - s.left)
            : h.width),
          (a = d
            ? Math.min(h.height, s.height, s.height + s.top, h.height - s.top)
            : h.height),
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            ...
            ft(
              this.face,
              g,
              i.width >= e.width && i.height >= e.height ? E : O
            ),
          ct(
            this.cropBox,
            rt(
              { width: i.width, height: i.height },
              Lt({ translateX: i.left, translateY: i.top })
            )
          ),
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (ct(
            ...
            rt(
              { width: d, height: l },
              Lt(rt({ translateX: -p, translateY: -m }, h))
            )
          ),
          ot(this.previews, function (t) {
            var e = gt(t, f),
    ...
    It = {
      ...
      unbind: function () {
        ...
        it(e.cropstart) && Bt(t, C, e.cropstart),
          ...
          e.zoomable &&
            e.zoomOnWheel &&
            Bt(i, "wheel", this.onWheel, { passive: !1, capture: !0 }),
    ...
    Pt = {
      ...
      cropStart: function (t) {
        ...
        this.disabled ||
          ...
          (a =
            1 < Object.keys(i).length && e.zoomable && e.zoomOnTouch
              ? W
              : gt(t.target, g)),
          q.test(a) &&
      ...
      cropEnd: function (t) {
        ...
        this.disabled ||
          ...
          e &&
            ...
            this.cropping &&
              ((this.cropping = !1),
              pt(this.dragBox, m, this.cropped && this.options.modal)),
    ...
    qt = {
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), lt(this.cropper, c)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), dt(this.cropper, c)),
          this
        );
      },
      destroy: function () {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (
          ...
          if (
            !1 ===
            Ot(this.element, P, { ratio: t, oldRatio: s / d, originalEvent: i })
          )
            return this;
          i
            ? ((p = this.pointers),
            ...
            : et(e) && V(e.x) && V(e.y)
            ? ((h.left -= (g - s) * ((e.x - h.left) / s)),
              (h.top -= (f - c) * ((e.y - h.top) / c)))
      ...
      getData: function (t) {
        ...
        return (
          ...
          r.scalable &&
            ((i.scaleX = h.scaleX || 1), (i.scaleY = h.scaleY || 1)),
          i
        );
      },
      setData: function (t) {
      ...
      getCroppedCanvas: function (t) {
        ...
        return (
          0 < pt &&
            0 < mt &&
            ((wt = et / Z), bt.push(dt * wt, lt * wt, pt * wt, mt * wt)),
          nt.drawImage.apply(
            nt,
            [q].concat(
              yt(
              ...
              1 < n &&
                ((this.url = (function (t, e) {
                  for (var i = [], a = new Uint8Array(t); 0 < a.length; )
                    i.push(Xt.apply(null, nt(a.subarray(0, 8192)))),
                      (a = a.subarray(8192));
          ...
          },
          {
            ...
            value: function () {
              ...
              this.sized &&
                ...
                dt(s, A),
                e.guides ||
                  dt(s.getElementsByClassName("".concat(d, "-dashed")), A),
                e.center ||
                  dt(s.getElementsByClassName("".concat(d, "-center")), A),
