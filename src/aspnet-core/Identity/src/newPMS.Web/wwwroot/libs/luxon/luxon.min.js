var luxon = (function (e) {
  ...
  function dn(e, t, n, r) {
    ...
    0 === f.length &&
      ...
      s !== a && (u[c] = (u[c] || 0) + l / (s - a)));
    var d,
      h = an.fromObject(Object.assign(u, r));
    return 0 < f.length
      ? (d = an.fromMillis(l, r)).shiftTo.apply(d, f).plus(h)
      : h;
  }
  var hn = {
      arab: "[٠-٩]",
    ...
    var c,
      ...
      y = (function (e, t, n) {
        ...
        if (r) {
          ...
          for (var s in n) {
            B(n, s) &&
              ((o = (i = n[s]).groups ? i.groups + 1 : 1),
              !i.literal &&
                i.token &&
                (a[i.token.val[0]] = i.deser(r.slice(u, u + o))),
              (u += o));
          }
          return [r, a];
        }
      ...
      n ||
        (a =
          e.old && e.old.ts === this.ts && e.old.zone.equals(t)
            ? ((o = (r = [e.old.c, e.old.o])[0]), r[1])
            : ((i = t.offset(this.ts)),
              (o = Jn(this.ts, i)),
              (o = (n = Number.isNaN(o.year) ? new xe("invalid input") : null)
                ? null
                : o),
              n ? null : i)),
        (this._zone = t),
    ...
    return (
      ...
      (e.setZone = function (e, t) {
        ...
        if (e.isValid) {
          ...
          return (
            (i || a) &&
              ((u = e.offset(this.ts)), (s = Yn(this.toObject(), u, e)[0])),
            Wn(this, { ts: s, zone: e })
          );
        }
