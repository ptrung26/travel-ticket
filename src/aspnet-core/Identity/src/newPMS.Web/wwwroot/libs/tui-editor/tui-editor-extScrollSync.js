        ...
        /***/ 48: /***/ function (module, exports, __webpack_require__) {
          ...
          var ScrollManager = (function () {
            function ScrollManager(sectionManager, cm, $previewContainerEl) {
              ...
              this.$contents = this.$previewContainerEl.find(
                ".tui-editor-contents"
              );
            ...
            _createClass(ScrollManager, [
              {
                ...
                value: function _getEditorSectionHeight(section) {
                  ...
                  height -= this.cm.heightAtLine(
                    section.start > 0 ? section.start - 1 : 0,
                    "local"
                  );
              ...
              },
              {
                ...
                value: function _getEditorLineHeightGapInSection(
                  section,
                  line
                ) {
                  var gap = this.cm.heightAtLine(line, "local");
                  gap -= this.cm.heightAtLine(
                    section.start > 0 ? section.start - 1 : 0,
                    "local"
                  );
              ...
              },
              {
                ...
                value: function _getScrollFactorsOfEditor() {
                  ...
                  var isEditorBottom =
                    scrollInfo.height - scrollInfo.top <=
                  ...
                  if (isEditorBottom) {
                    ...
                    ratio = this._getEditorSectionScrollRatio(
                      topSection,
                      topLine
                    );
              ...
              },
              {
                ...
                value: function _getCursorFactorsOfEditor() {
                  ...
                  // if codemirror has not visible scrollInfo have incorrect value
                  // so we use saved scroll info for alternative
                  var scrollInfo = this._fallbackScrollInfoIfIncorrect(
                    cm.getScrollInfo()
                  );
                  ...
                  var cusrsorSection =
                    this.sectionManager.sectionByLine(cursorLine);
                  ...
                  if (
                    ...
                    var ratio = this._getEditorSectionScrollRatio(
                      cusrsorSection,
                      cursorLine
                    );
                ...
                value: function _getScrollInfoForMarkdown() {
                  ...
                  _tuiCodeSnippet2.default.forEachArray(
                    ...
                    function (section) {
                      ...
                      var isPreviewBottom =
                        $preview[0].clientHeight - $preview.scrollTop() <=
                        $preview[0].height;
                      var needNext = true;
                      ...
                      if (isPreviewBottom) {
                        ...
                        factors = {
                          section: section,
                          sectionRatio: _this._getMarkdownEditorScrollRatio(
                            $preview,
                            $div
                          ),
                        };
              ...
              },
              {
                ...
                value: function _getMarkdownEditorScrollRatio($preview, $div) {
                  return (
                    ($preview.scrollTop() - $div[0].offsetTop) / $div.height()
                  );
                },
              ...
              },
              {
                ...
                value: function _getScrollTopForPreview() {
                  ...
                  if (scrollFactors.isEditorBottom) {
                    ...
                    scrollTop +=
                      section.$previewSectionEl.height() * sectionRatio -
                      SCROLL_TOP_PADDING;
                  }
              ...
              },
              {
                ...
                value: function syncPreviewScrollTopToMarkdown(isCursorBase) {
                  ...
                  var targetScrollTop = isCursorBase
                ...
                value: function _animateRun(originValue, targetValue, stepCB) {
                  ...
                  function step() {
                    ...
                    if (progress < 1) {
                      deltaValue =
                        originValue +
                        valueDiff * Math.cos(((1 - progress) * Math.PI) / 2);
              ...
              },
              {
                ...
                value: function _fallbackScrollInfoIfIncorrect(scrollInfo) {
                  return scrollInfo.height < 0 && this._savedScrollInfo
                    ? this._savedScrollInfo
                    : scrollInfo;
                },
              ...
              },
              {
                ...
                value: function _isTopSection($preview, $div) {
                  ...
                  var isSectionBegin =
                    previewScrollTop >= divOffsetTop - PREVIEW_MARGIN_TOP;
                  var isSectionEnd =
                    previewScrollTop > divOffsetTop + divHeight;
          ...
          var SectionManager = (function () {
            ...
            _createClass(SectionManager, [
              ...
              },
              {
                ...
                value: function _eachLineState(iteratee) {
                  ...
                  for (i = 0; i < lineLength; i += 1) {
                    ...
                    var isCodeBlockEnded =
                      this._isCodeBlockEnd(prevLineString) &&
                      codeblockStartLineIndex !== i - 1;

                    if (
                      isInTable &&
                      (!lineString || !this._isTableCode(lineString))
                    ) {
                      isInTable = false;
                    } else if (
                      !isInTable &&
                      this._isTable(lineString, nextLineString)
                    ) {
                      isInTable = true;
                    }
                    ...
                    if (!isInCodeBlock && this._isCodeBlockStart(lineString)) {
                      isInCodeBlock = this._doFollowedLinesHaveCodeBlockEnd(
                        i,
                        lineLength
                      );
              ...
              },
              {
                ...
                value: function _isIndependentImage(
                  isInCodeBlock,
                  isInTable,
                  lineString,
                  prevLineString
              ...
              },
              {
                ...
                value: function _doFollowedLinesHaveCodeBlockEnd(
                  lineIndex,
                  lineLength
                ) {
              ...
              },
              {
                ...
                value: function _isTable(lineString, nextLineString) {
                  return (
                    this._isTableCode(lineString) &&
                    this._isTableAligner(nextLineString)
                  );
                },
              ...
              },
              {
                ...
                value: function _matchPreviewSectionsWithSectionlist(sections) {
                  ...
                  sections.forEach(function (childs, index) {
                    ...
                    if (section) {
                      var $sectionDiv = (0, _jquery2.default)(
                        "<div class='content-id-" + index + "'></div>"
                      );
                      section.$previewSectionEl = (0, _jquery2.default)(childs)
                        .wrapAll($sectionDiv)
                        .parent();
                    }
                  });
                ...
                value: function _getPreviewSections() {
                  ...
                  this.$previewContent
                    ...
                    .each(function (index, el) {
                      ...
                      if (
                        (isHeading || isImage || isRightAfterImageSection) &&
