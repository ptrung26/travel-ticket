  ...
  if ("object" == typeof exports && "object" == typeof module)
    ...
    var r =
      "object" == typeof exports
        ...
        : e(t.$, t.tui.util, t.tui.Editor, t.tui.Editor, t.tui.chart);
    for (var n in r) ("object" == typeof exports ? exports : t)[n] = r[n];
  }
})(window, function (t, e, r, n, i) {
  return (function (t) {
    var e = {};
    function r(n) {
    ...
    function (t, e, r) {
      ...
      (function (e, n, i) {
        ...
        function b(t) {
          if (((s = s || r(8)), !(p.call(b, this) || this instanceof s)))
            return new b(t);
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var f = r.chunk,
                ...
                l = r.callback;
              if (
                (m(t, e, !1, e.objectMode ? 1 : f.length, f, c, l),
                (r = r.next),
            ...
            ? ((p = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(b, Symbol.hasInstance, {
                value: function (t) {
                  return (
                    !!p.call(this, t) ||
                    (this === b && t && t._writableState instanceof v)
                  );
                },
              }))
            : (p = function (t) {
      ...
      }.call(this, r(12), r(34).setImmediate, r(10)));
    },
    function (t, e, r) {
      t.exports = i;
      var n = r(15).EventEmitter;
      function i() {
        n.call(this);
      }
      r(9)(i, n),
      ...
      (function (e, n) {
        ...
        function b(t, e) {
          ...
          (this.highWaterMark = i || 0 === i ? i : n && (a || 0 === a) ? a : s),
            ...
            (this.encoding = null),
            t.encoding &&
              (p || (p = r(24).StringDecoder),
              (this.decoder = new p(t.encoding)),
              (this.encoding = t.encoding));
        }
        function m(t) {
          if (((o = o || r(8)), !(this instanceof m))) return new m(t);
        ...
        (m.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? M(this) : S(this),
              null
            );
          ...
          return (
            ...
            null === (n = t > 0 ? L(t, e) : null)
              ...
              : (e.length -= t),
            0 === e.length &&
              (e.ended || (e.needReadable = !0), r !== t && e.ended && M(this)),
        ...
        (u.prototype.slice = function (t, e) {
          ...
          (u.prototype.fill = function (t, e, r, n) {
            ...
            if (
              ...
              var a = u.isBuffer(t) ? t : W(new u(t, n).toString()),
                s = a.length;
    ...
    function (t, e, r) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.setDefaultOptions =
          e.detectDelimiter =
          e.parseDSV2ChartData =
          e.parseCode2ChartOption =
          e.parseURL2ChartData =
          e.parseCode2DataAndOptions =
            void 0);
      var n = (function () {
          function t(t, e) {
      ...
      var l = u.default.WwCodeBlockManager,
        h = u.default.codeBlockManager,
        d = "chart";
      (f.default.IGNORE_QUOTE_WHITESPACE = !1),
        (f.default.IGNORE_RECORD_LENGTH = !0),
        (f.default.DETECT_TYPES = !1);
      var p = /[\n\r]/,
        g = [",", "\t", /\s+/],
        y = ":",
        v = ["barChart", "columnChart", "lineChart", "areaChart", "pieChart"],
      ...
      function w(t, e) {
        var r = (t = O(t)).split(/\n{2,}/),
          ...
          i = r[1],
          s = T(n),
          u = s && s.editorChart && s.editorChart.url,
          f = void 0;
        if (a.default.isString(u)) {
          o.default
            .get(u)
            .done(function (t) {
              (f = _(t, n)), e(f);
      ...
      function _(t, e) {
        return { data: S(t), options: T(e) };
      }
      function E(t) {
        var e = (t = O(t)).split(p).slice(0, 10).join("\n");
        return g
          .map(function (t) {
            return { delimiter: t, delta: R(e, t) };
          })
          .sort(function (t, e) {
      ...
      function R(t, e) {
        ...
        try {
          if (
            ((f.default.COLUMN_SEPARATOR = e),
            (r = f.default.parse(t))[0].length < 2)
          )
          ...
          n = r
            ...
            .reduce(
              function (t, e) {
                return {
                  deltaSum: t.deltaSum + Math.abs(t.length - e),
                  length: e,
                };
              },
              { deltaSum: 0, length: r[0].length }
            ).deltaSum;
        } catch (t) {
          n = 1 / 0;
        }
      ...
      function S(t, e) {
        (t = O(t)), (f.default.COLUMN_SEPARATOR = e || E(t));
        var r = f.default.parse(t),
          n = (r = r.map(function (t) {
          ...
          i = n ? r.shift() : [],
          o = r.slice(1).reduce(function (t, e) {
            return t || !A(e[0]);
          }, !1),
          a = o
            ? r.map(function (t) {
        ...
        return (
          ...
          {
            categories: a,
            series: (r = r[0].map(function (t, e) {
              return r.map(function (t) {
                return parseFloat(t[e]);
              });
            })).map(function (t, e) {
              return n ? { name: i[e], data: t } : { data: t };
            }),
          }
        );
      }
      function T(t) {
        var e = ["type", "url"],
          r = {};
        return a.default.isUndefined(t)
          ? r
          : (t.split(p).forEach(function (t) {
              ...
              if (((i = i.trim()), 0 !== o.length)) {
                ...
                var s = i.split(".").slice(0),
                  u = s[0];
                a.default.inArray(u, e) >= 0
                  ? s.unshift("editorChart")
                  : 1 === s.length
                  ? s.unshift("chart")
                  : ("x" !== u && "y" !== u) || (s[0] = u + "Axis");
                for (var f = r, c = 0; c < s.length; c += 1) {
                  var l = s[c];
                  (f[l] = f[l] || (s.length - 1 === c ? o : {})), (f = f[l]);
                }
              }
            }),
            r);
      ...
      function x(t, e, r) {
        (t = a.default.extend(
          ...
          (e = a.default.extend(m, e));
        var n = t.chart,
          i = n.width,
          o = n.height,
          s = a.default.isUndefined(i),
          u = a.default.isUndefined(o);
        if (s || u) {
          var f = r.getBoundingClientRect().width;
          (i = "auto" === (i = s ? e.width : i) ? f : i),
            (o = "auto" === (o = u ? e.height : o) ? f : o);
        }
        return (
          (i = Math.min(e.maxWidth, i)),
          (o = Math.min(e.maxHeight, o)),
          (t.chart.width = Math.max(e.minWidth, i)),
          (t.chart.height = Math.max(e.minHeight, o)),
          (t.editorChart.type = t.editorChart.type
            ? t.editorChart.type + "Chart"
            : "columnChart"),
          (t.chartExportMenu.visible = t.chartExportMenu.visible || !1),
          t
        );
      }
      function C(t) {
        return t.reduce(function (t, e) {
          var r = e.map(function (t) {
            return !A(t) && t.indexOf(" ") >= 0 && (t = '"' + t + '"'), t;
          });
          return t.push(r.join("\t")), t;
        }, []);
      }
      function k(t) {
        var e = t.wwEditor.componentManager;
        e.removeManager("codeblock"),
          e.addManager(
            (function (t) {
              function e() {
                return (
                ...
                n(e, [
                  {
                    ...
                    value: function (t) {
                      if (1 !== t.length || "TABLE" !== t[0].tagName)
                        return i(
                      ...
                      var r = t.shift(),
                        n = "";
                      return (n += C(
                        [].slice.call(r.rows).map(function (t) {
                          return [].slice.call(t.cells).map(function (t) {
      ...
      u.default.defineExtension("chart", function (t) {
        var e =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          r = t.options.codeBlockLanguages;
        r && r.indexOf(d) < 0 && r.push(d),
          (e = a.default.extend(
            { usageStatistics: t.options.usageStatistics },
            e
          )),
          h.setReplacer(d, function (t) {
            return (function (t, e) {
              var r = "chart-" + Math.random().toString(36).substr(2, 10),
                n = '<div id="' + r + '" class="chart" />';
              return (
                setTimeout(function () {
                  ...
                  try {
                    w(t, function (t) {
                      var r = t.data,
                        i = t.options,
                        o = (i = x(i, e, n)).editorChart.type;
                      v.indexOf(o) < 0
                        ? (n.innerHTML =
                            "invalid chart type. type: bar, column, line, area, pie")
                        : b.indexOf(o) > -1 &&
                          r.categories.length !== r.series[0].data.length
                        ? (n.innerHTML = "invalid chart data")
                        : s.default[o](n, r, i);
                    });
                  } catch (t) {
                    n.innerHTML = "invalid chart data";
          ...
          t.isViewer() ||
            (k(t),
            t.eventManager.listen("pasteBefore", function (e) {
              return (function (t, e) {
                var r = e.source,
                  n = e.data;
                if (
                  (function (t, e, r) {
                    var n =
                      "markdown" === e &&
                      t.getTokenAt(r.from).state.overlay.codeBlock;
                    return (n =
                      (n = n || "codeblock" === e) && "wysiwyg" !== e);
                  })(t, r, n)
                ) {
                  var i = n.text.join("\n");
                  if (0 === R(i, "\t")) {
                    f.default.COLUMN_SEPARATOR = "\t";
                    var o = C(f.default.parse(i));
                    n.update(n.from, n.to, o);
                  }
                }
              })(t.mdEditor.cm, e);
            }));
      }),
        (e.parseCode2DataAndOptions = w),
        (e.parseURL2ChartData = function (t, e) {
          o.default
            .get(t)
            .done(function (t) {
              var r = S(t);
        ...
        (e.parseCode2ChartOption = T),
        (e.parseDSV2ChartData = S),
        (e.detectDelimiter = E),
        (e.setDefaultOptions = x);
    },
    function (t, e) {
      t.exports = i;
    },
    function (t, e, r) {
      ...
      ((n = {
        ...
        for (
          n.COLUMN_SEPARATOR =
            n.COLUMN_SEPARATOR instanceof RegExp
              ? new RegExp("^" + n.COLUMN_SEPARATOR.source)
              : n.COLUMN_SEPARATOR,
            n.offset = 0,
            n.str = t,
            n.record_begin(),
          ...
          if (((e = t[n.offset++]), n.debug("c", e), null == e)) {
            n.escaped && n.error(n.ERROR_EOF),
              n.record && (n.token_end(), n.record_end()),
              n.debug("...bail", e, n.state, n.record),
              n.reset();
            break;
          }
          if (null == n.record) {
          ...
          if (0 == n.state) {
            if ((" " === e || "\t" === e) && '"' == n.next_nonspace()) {
              if (n.RELAXED || n.IGNORE_QUOTE_WHITESPACE) continue;
              n.warn(n.WARN_SPACE);
            }
            if ('"' == e && !n.IGNORE_QUOTES) {
              n.debug("...escaped start", e), (n.escaped = !0), (n.state = 1);
              continue;
            }
            n.state = 1;
          }
          1 == n.state && n.escaped
            ? '"' == e
              ? '"' == t[n.offset]
                ? (n.debug("...escaped quote", e), (n.token += '"'), n.offset++)
                : (n.debug("...escaped end", e),
                  (n.escaped = !1),
                  (n.state = 2))
              : ((n.token += e), n.debug("...escaped add", e, n.token))
            : "\r" == e
            ? ("\n" == t[n.offset]
                ? n.offset++
                : n.CARRIAGE_RETURN_OK || n.error(n.ERROR_CHAR),
              n.token_end(),
              n.record_end())
            : "\n" == e
            ? (n.LINE_FEED_OK || n.RELAXED || n.error(n.ERROR_CHAR),
              n.token_end(),
              n.record_end())
            : n.test_regex_separator(t) || n.COLUMN_SEPARATOR == e
            ? n.token_end()
            : 1 == n.state
            ? ((n.token += e), n.debug("...add", e, n.token))
            : " " === e || "\t" === e
            ? n.IGNORE_QUOTE_WHITESPACE || n.error(n.WARN_SPACE)
            : n.RELAXED || n.error(n.ERROR_CHAR);
        }
        return r;
      }),
        (n.stream = function () {
          var t = new (r(18).Transform)({ objectMode: !0 });
          return (
            (t.EOL = "\n"),
            (t.prior = ""),
            (t.emitter = (function (t) {
              return function (e) {
                t.push(n.parse(e + t.EOL));
              };
            })(t)),
            (t._transform = function (t, e, r) {
              var n =
                "" == this.prior
                  ? t.toString().split(this.EOL)
                  : (this.prior + t.toString()).split(this.EOL);
              (this.prior = n.pop()), n.forEach(this.emitter), r();
            }),
            (t._flush = function (t) {
        ...
        (n.test_regex_separator = function (t) {
          return (
            n.COLUMN_SEPARATOR instanceof RegExp &&
            ((t = t.slice(n.offset - 1)),
            (e = n.COLUMN_SEPARATOR.exec(t)) && (n.offset += e[0].length - 1),
            null !== e)
          );
          var e;
        }),
        (n.stream.json = function () {
          var t = r(42),
            e = (r(18), new streamTransform({ objectMode: !0 }));
          return (
            (e._transform = function (r, n, i) {
              e.push(JSON.stringify(r.toString()) + t.EOL), i();
            }),
            e
          );
        }),
        ...
        (n.next_nonspace = function () {
          for (var t, e = n.offset; e < n.str.length; )
            if (" " != (t = n.str[e++]) && "\t" !== t) return t;
          return null;
        }),
        (n.record_begin = function () {
          (n.escaped = !1),
            (n.record = []),
            n.token_begin(),
            n.debug("record_begin");
        }),
        (n.record_end = function () {
          (n.state = 4),
            !n.IGNORE_RECORD_LENGTH &&
              !n.RELAXED &&
              n.result.length > 0 &&
              n.record.length != n.result[0].length &&
              n.error(n.ERROR_EOL),
            n.result.push(n.record),
            n.debug("record end", n.record),
            (n.record = null);
        }),
        (n.resolve_type = function (t) {
          return (
            t.match(/^[-+]?[0-9]+(\.[0-9]+)?([eE][-+]?[0-9]+)?$/)
              ? (t = parseFloat(t))
              : t.match(/^(true|false)$/i)
              ? (t = Boolean(t.match(/true/i)))
              : "undefined" === t
              ? (t = void 0)
              : "null" === t && (t = null),
            t
        ...
        (n.token_begin = function () {
          (n.state = 0), (n.token = "");
        }),
        (n.token_end = function () {
          n.DETECT_TYPES && (n.token = n.resolve_type(n.token)),
            n.record.push(n.token),
            n.debug("token end", n.token),
            n.token_begin();
        }),
        (n.debug = function () {
    ...
    function (t, e, r) {
      t.exports = r(16).Transform;
    },
    function (t, e, r) {
      t.exports = r(16).PassThrough;
    },
    function (t, e) {
