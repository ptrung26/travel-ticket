(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global = global || self),
      factory(
        ...
        (global.abp.utils = global.abp.utils || {}),
        (global.abp.utils.common = {})),
        global.compare
      ));
  ...
  compare =
    compare && Object.prototype.hasOwnProperty.call(compare, "default")
      ? compare["default"]
      : compare;
  ...
  var LinkedList = /** @class */ (function () {
    ...
    LinkedList.prototype.attachMany = function (
      values,
      previousNode,
      nextNode
    ) {
    ...
    LinkedList.prototype.add = function (value) {
      ...
      return {
        after: function () {
          ...
          return (_a = _this.addAfter).call.apply(
            _a,
            __spread([_this, value], params)
          );
        },
        before: function () {
          var _a;
          ...
          return (_a = _this.addBefore).call.apply(
            _a,
            __spread([_this, value], params)
          );
        },
    ...
    LinkedList.prototype.addMany = function (values) {
      ...
      return {
        after: function () {
          ...
          return (_a = _this.addManyAfter).call.apply(
            _a,
            __spread([_this, values], params)
          );
        },
        before: function () {
          var _a;
          ...
          return (_a = _this.addManyBefore).call.apply(
            _a,
            __spread([_this, values], params)
          );
        },
    ...
    LinkedList.prototype.addAfter = function (value, previousValue, compareFn) {
      ...
      return previous
        ? this.attach(value, previous, previous.next)
        : this.addTail(value);
    };
    LinkedList.prototype.addBefore = function (value, nextValue, compareFn) {
      ...
      return next
        ? this.attach(value, next.previous, next)
        : this.addHead(value);
    };
    ...
    LinkedList.prototype.addManyAfter = function (
      values,
      previousValue,
      compareFn
    ) {
      ...
      return previous
        ? this.attachMany(values, previous, previous.next)
        : this.addManyTail(values);
    };
    LinkedList.prototype.addManyBefore = function (
      values,
      nextValue,
      compareFn
    ) {
      ...
      return next
        ? this.attachMany(values, next.previous, next)
        : this.addManyHead(values);
    };
    ...
    LinkedList.prototype.dropByValueAll = function (value, compareFn) {
      ...
      var dropped = [];
      for (
        var current = this.first, position = 0;
        current;
    ...
    LinkedList.prototype.forEach = function (iteratorFn) {
      for (
        var node = this.first, position = 0;
        node;
