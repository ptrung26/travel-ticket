...
{
    public class newPMSDbMigrationService : ITransientDependency
    {
        public ILogger<newPMSDbMigrationService> Logger { get; set; }
        ...
        public newPMSDbMigrationService(
            ...
            IEnumerable<InewPMSDbSchemaMigrator> dbSchemaMigrators)
        {
            ...
            Logger = NullLogger<newPMSDbMigrationService>.Instance;
        }
