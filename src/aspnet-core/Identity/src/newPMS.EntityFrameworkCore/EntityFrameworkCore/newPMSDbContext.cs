...
namespace newPMS.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See newPMSMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class newPMSDbContext : AbpDbContext<newPMSDbContext>
    {
        ...
        public newPMSDbContext(DbContextOptions<newPMSDbContext> options)
            : base(options)
        {
